    ...
    <div id="home" className="relative bg-white pt-20">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 lg:mt-16 lg:px-8 xl:mt-20">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block">Salem Taleb Efaifa</span>
                <span className="block text-blue-600">Auditing & Consultancy</span>
              </h1>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          ...
          src="https://ik.imagekit.io/ri5cvrkrr/neve-accounting-08.jpg?updatedAt=1732207350524"
