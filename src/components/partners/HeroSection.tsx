    ...
    <div className="relative bg-gradient-to-r from-[#00204A] to-[#002B5B] text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative py-12">
        ...
        >
          ...
          <h1 className="text-3xl font-medium tracking-tight bg-gradient-to-r from-[#FFC635] to-[#FFD700] bg-clip-text text-transparent">
            Our Partners
          </h1>
          <div className="h-0.5 w-12 bg-[#FFC635]/20 my-4"></div>
          <p className="text-[#FFC635]/80 text-lg font-light">
